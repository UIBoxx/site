function PrivacyPolicy() {
  return (
    <div className="privacy" style={{margin: '20px'}}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to UIBoxx, Kathmandu.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to uiboxx.in, accessible from{" "}
            <a
              href="https://www.uiboxx.in/"
      ...
      <ul>
        <li>By email: contact@uiboxx.in</li>
      </ul>
    </div>
  );
}
