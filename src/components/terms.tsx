function TermsAndConditions() {
  return (
    <div className="terms" style={{ margin: "20px" }}>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to uiboxx.in!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of UIBoxx's Website, located at https://www.uiboxx.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use uiboxx.in if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of np. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing uiboxx.in, you agreed to use
        cookies in agreement with the UIBoxx's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, UIBoxx and/or its licensors own the
        intellectual property rights for all material on uiboxx.in. All
        intellectual property rights are reserved. You may access this from
        uiboxx.in for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You can not:</p>
      <ul>
        <li>Republish material from uiboxx.in</li>
        <li>Sell, rent or sub-license material from uiboxx.in</li>
        <li>Reproduce, duplicate or copy material from uiboxx.in</li>
        <li>Redistribute content from uiboxx.in</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        UIBoxx does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of UIBoxx,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, UIBoxx shall not be liable for the
      ...
      <p>
        UIBoxx reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant UIBoxx a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of UIBoxx; and (d) the link is in
      ...
      <p>
        ...
        e-mail to UIBoxx. Please include your name, your organization name,
      ...
      <p>
        No use of UIBoxx's logo or other artwork will be allowed for linking
